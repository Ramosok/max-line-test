...
export const Form: FC = () => {
  ...
  return (
    <article className="z-[3] flex h-[45vh] min-h-[426px] w-full flex-col items-center self-end rounded-t-3xl bg-purple-darkest px-[50px] pt-[30px] contain-layout contain-paint 768:h-full 768:w-[400px] 768:justify-center 768:rounded-none 768:bg-black_07 768:p-[50px] 768:pt-0 1024:w-[480px] 1024:p-[100px] 1280:w-[580px]">
