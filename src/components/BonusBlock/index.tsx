...
export const BonusBlock = () => {
  return (
    <div className="relative left-0 top-0 z-[3] flex h-auto flex-col items-center justify-center contain-layout contain-paint 768:left-12 768:top-48">
      ...
      <p className="leading-0 -translate-y-2 font-MTS_Sans text-[25px] font-black text-white [text-shadow:0_4px_0_#000] 768:text-[50px]">
        ЗА РЕГИСТРАЦИЮ
      </p>
    </div>
  );
