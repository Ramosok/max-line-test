...
export const BonusBlock = () => {
  return (
    <div className="relative left-0 top-0 z-[3] flex h-auto max-w-[100vw] scale-100 flex-col items-center justify-center overflow-x-hidden contain-layout contain-paint 768:left-32 768:top-[20vh] 768:scale-[60%] 968:scale-75 1024:left-12 1024:scale-100">
